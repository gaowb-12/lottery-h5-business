<template>
	<view class="box">
			...
			<view
				...
				<view style="display: flex; justify-content: space-between; align-items: center;">
					...
					<u-radio-group v-model="documentaryParam.state">
						<u-radio activeColor="#515ffb" :customStyle="{marginLeft: '20px'}" v-for="(item, index) in list"
				...
				<view style="display: flex; justify-content: space-between; align-items: center;">
					...
					<u-radio-group v-model="documentaryParam.commission">
						<u-radio activeColor="#515ffb" :customStyle="{marginLeft: '16px'}"
			...
			<view style="position: fixed; bottom: 10px; right: 5%; width: 90%;">
				<u-button color="#515ffb" text="确认发单" style="border-radius: 10px;" @click="confirm"></u-button>
			</view>
