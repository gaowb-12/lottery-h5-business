<template>
	<view class="box">
		<cmd-nav-bar title="竞彩足球" :back="true" font-color="#fff" background-color="#515ffb" @rightText="rightText"
			right-text="足球开奖">
		</cmd-nav-bar>
		<div class="soccer_wrap">
			...
			<div class="soccer_main" v-show="isMainShow">
				<u-sticky bgColor="#fff"
					...
					<u-tabs :list="lassificationcList" lineColor="#515ffb"
									...
									<table>
										<tr>
												...
												<p>
													<span style="position: relative;"
														...
														<view
															...
															style="position: absolute; left: 0px; top: 0px; width: 0px; height: 0px; border-top: 25px solid #515ffb; border-right: 25px solid transparent;">
															<view
											...
											<td class="morePlay" rowspan="2" @tap="morePlay(game,weekIdx,index)">
												...
												<span v-else>已选<span
														style="color: #515ffb;display: block">{{game.choiceCount}}</span>项</span>
											</td>
										</tr>
										<tr>
								...
								<div class="games_right">
									...
									<div @click="morePlay(game,weekIdx,idx)">
										<span v-for="s in game.scoreOddsList" v-if="s.active"
											style="color: #515ffb;font-weight: bold">
											{{s.describe}} |
										</span>
