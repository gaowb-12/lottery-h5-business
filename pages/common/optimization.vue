	...
	<view class="box">
		...
		<view class="body">
			<u-sticky style="margin-top: 30px;">
				<u-subsection :list="list" mode="subsection" inactiveColor="#515ffb" fontSize="14" :current="current"
					activeColor="#515ffb" @change="subsectionChange">
				</u-subsection>
			</u-sticky>
		...
		<view style="position: fixed;bottom: 0px; left: 0;width: 100%;">
			<u-line></u-line>
			<p style="text-align: center;padding: 5px 0px;">单注预测奖金:<span style="color: #515ffb;">{{this.min}}~{{this.max}}</span></p>
			<u-line></u-line>
			<view style="display: flex;justify-content: space-between;align-items: center;height: 50px;">
				<view style="margin-left: 10px;">
					方案共:<span
						style="color: #515ffb;">{{this.calculationParam.notes*this.calculationParam.multiple*2}}元</span>
				</view>
				
				<view style="position: fixed;right: 0;bottom: 0px;">
					<u-button style="background-color: #515ffb; color: #ffffff;border-radius: 10px 0px 0px 10px;padding: 10px 35px;"
