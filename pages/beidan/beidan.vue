<template>
	<view class="box">
		<cmd-nav-bar title="北京单场" :back="true" font-color="#fff" background-color="#515ffb" @rightText="rightText"
			right-text="北单开奖">
		</cmd-nav-bar>
							...
							<div class="games" v-for="(game,idx) in wk.beiDanMatchList">
								...
								<div class="games_right">
									...
									<div @click="morePlay(game,weekIdx,idx)">
										<span v-for="s in game.scoreOddsList" v-if="s.active" style="color: #515ffb;font-weight: bold">
											{{s.describe}} |
										</span>
						...
						<div class="weekGame_games" v-show="isShowGames === weekIdx">
							...
							<div class="games" v-for="(game,idx) in wk.beiDanMatchList">
								...
								<div class="games_right">
									...
									<!--投注区-->
									<div @click="morePlay(game,weekIdx,idx)">
										<span v-for="s in game.halfWholeOddsList" v-if="s.active" style="color: #515ffb;font-weight: bold">
											{{s.describe}} |
										</span>
